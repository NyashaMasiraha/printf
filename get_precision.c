...
/**
 * get_precision - a function that calculate precision for printing integers
 * @format: string from which to print the arguments
 * @n: pointer to int arguments to be printed.
 * @list: arguments list
 * Return: Precision.
 */
